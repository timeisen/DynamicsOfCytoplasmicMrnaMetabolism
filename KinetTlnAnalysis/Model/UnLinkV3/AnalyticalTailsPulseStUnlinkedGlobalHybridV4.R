...
# all_data_fn<-"/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/model_input_files/randomized_gene_sets/miR-155_minus_rand_g_v7_last8rm_HYBRID20190603_"
# i <- args[1]
...
out_file <- paste0("/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/rate_constant_measurements/global_model_fits/v8/Multicore_HYBRID20190603_weighted_minus_miR-155_",i,".txt")
...
# [1] 9.602977e-16  [1] 3.100246e-16  none  none
# [1] 3.301216e-15  [1] 1.064988e-15  [1] 2.3981e-15    [1] 5.654348e-15
# [1] 7.954556e-15  [1] 1.464289e-15  [1] 8.561433e-15  [1] 1.208194e-14
# [1] 2.074865e-14  [1] 7.878394e-15  [1] 2.648917e-14  [1] 1.522358e-14
# [1] 8.75621e-14   [1] 4.239144e-14  [1] 2.383641e-14  [1] 3.382383e-14
# [1] 3.719348e-13  [1] 3.494937e-13  [1] 1.621572e-13  [1] 1.61126e-13
...
#scales that last 8 nt of the steady state by 6, for all of the time points.  
oneGeneRm = c((6*242+1):(6*250))
oneGeneAd = oneGeneRm[c((1:8)*6)]
