...
bootstrap_params <- read.table("/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/rate_constant_measurements/global_model_fits/bootstrapHYBRID/miR-155_minus_rand_g_rates_plogis_unlinked_HYBRID20190430_compiled_summarize.txt",sep="\t",head=TRUE)
