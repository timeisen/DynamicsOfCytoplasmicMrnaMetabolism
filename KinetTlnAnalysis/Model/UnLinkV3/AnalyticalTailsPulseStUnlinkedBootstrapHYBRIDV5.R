...
bootstrap_params <- read.table("/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/rate_constant_measurements/global_model_fits/bootstrapHYBRID/miR-155_minus_rand_g_rates_plogis_unlinked_HYBRID20190831_compiled_summarize.txt",sep="\t",head=TRUE)
...
Simulation <- function(pars,time){ ##This is the main simulator
  ...
  k        = pars[3]
  b        = pars[4]
  size     = global_params[1] #These are globally fitted parameters 2019 04 22. 
