...
all_data_fn<-"/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/model_input_files/randomized_gene_sets/miR-1_minus_rand_g_v6_last8rm_HYBRID20190308_"
i <- args[1]
...
# all_data<-fread("model_input_files/TEST5_genes_miR-1_minus_sample_means_background_subtracted_v6_st_global_last8rm_HYBRID.txt",head=TRUE)
# data<-as.matrix(all_data)
# i<-"test"
print(detectCores())
...
out_file <- paste0("/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/rate_constant_measurements/global_model_fits/v8/Multicore_HYBRID20190308_minus_miR-1_",i,".txt")
