...
all_data_fn<-"/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/model_input_files/randomized_gene_sets/bootstrap/miR-155_minus_rand_g_HYBRID20190326_"
i <- args[1]
j <- args[2]
...
out_file <- paste0("rate_constant_measurements/global_model_fits/bootstrapHYBRID/","miR-155_minus_rand_g_rates_plogis_unlinked_HYBRID20190326_",i,"_BOOTSTRAP_",j,".txt")
