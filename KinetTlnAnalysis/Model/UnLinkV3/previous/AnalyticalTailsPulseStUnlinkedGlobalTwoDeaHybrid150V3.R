...
out_file <- paste0("/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/rate_constant_measurements/global_model_fits/v7/Multicore_20190326_HYBRID_minus_TwoDea_150_",i,".txt")
