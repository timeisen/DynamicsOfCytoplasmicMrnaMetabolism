...
vars <<- c(      #miR-155 minus
  ...
  4.320013e-14,
  2.567023e-13,
  2.567023e-13/6) #The variance of the last value is reduced 6 fold
...
Simulation<-function(pars,time){ ##cleanup
  ...
  k2       = pars[4]
  b        = pars[5]
  size     = 21.1387083    #110 21.1387083, 25 datasets. #150: 13.8574646   
  location = 260.0190246   #110 260.0190246 #150: 260.4219318 
  scale    = 9.1010557    #110 9.1010557 #150: 8.7416984   
  ...
  tails <- ode.band(func = "ode_deriv", 
    ...
    banddown = 1,
    nspec = max_tail*N, 
    dllname = "AnalyticalTailsPulseStUnlinkedGlobalTwoDea110",
    nout=1,
    initfunc = "ode_p_init",
    hmax = 1,
    maxsteps=5000000)
