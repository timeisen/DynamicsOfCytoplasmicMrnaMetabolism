...
Simulation<-function(pars,time){ ##cleanup
  ...
  tails <- ode.band(func = "ode_deriv", y = initial_state, parms = parameters, times=c(0,time),method = "lsode",bandup = 0, banddown = 1,nspec = max_tail*N, dllname = "AnalyticalTailsPulseStUnlinkedGlobalTwoDea110",nout=1,initfunc = "ode_p_init",hmax = 60)
