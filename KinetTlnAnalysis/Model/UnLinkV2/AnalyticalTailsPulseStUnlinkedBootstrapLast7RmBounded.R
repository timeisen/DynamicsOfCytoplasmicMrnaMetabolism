...
#linked: 213502562
#unlinked: 225708248
bootstrap_params <- read.table("/lab/solexa_bartel/teisen/Tail-seq/miR-155_final_analyses/rate_constant_measurements/global_model_fits/bootstrapHYBRID/miR-155_unlinked_rates_compiled_median_HYBRID_20180925.txt",sep="\t",head=TRUE)
