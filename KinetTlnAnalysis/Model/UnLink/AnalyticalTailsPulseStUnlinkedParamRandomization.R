...
Optimization<-function(initial_param,data,plot=FALSE,time_points){
  ...
  for(x in 1:10){
    ...
    initial_param<-log2(runif(4,min=c(133.8162,2.342363e-08,0.1330985,0.4312363),max=c(187.6107,6.600286e-07,6.2559904,42.2136320))) #this is 5th to 95th percentile
