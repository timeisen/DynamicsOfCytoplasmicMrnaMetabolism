...
Optimization<-function(initial_param,data,plot=FALSE,time_points){
  ...
  optim_param<-NULL
  for(x in 1:1){
    initial_param<-log2(runif(3,min=c(4.317860e-08,2.650033e-01,100*2.650033e-01),max=c(1.396230e-07,9.549402e-01,100*9.549402e-01)))
