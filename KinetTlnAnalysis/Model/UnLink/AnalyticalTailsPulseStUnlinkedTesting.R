...
initial_param<-c(140,1E-7,1,1/10000)
dir <- args[3]
N<<-1
...
Optimization<-function(initial_param,data,plot=FALSE,time_points){
  ...
  for(x in 1:1){
    ...
    initial_param<-log2(runif(4,min=c(147.16777,4.317860e-08,2.650033e-01,2.650033e-03),max=c(168.41418,1.396230e-07,9.549402e-01,9.549402e03)))
