...
tp40m_ <- fread("single_tag_files/background_subtracted_single_tag_files/tp40m_bs_minus_miR-1_v7.txt")
tp1hr_ <- fread("single_tag_files/background_subtracted_single_tag_files/tp1hr_bs_minus_miR-1_v7.txt")
tp2hr_ <- fread("single_tag_files/background_subtracted_single_tag_files/tp2hr_bs_minus_miR-1_v7.txt")
tp4hr_ <- fread("single_tag_files/background_subtracted_single_tag_files/tp4hr_bs_minus_miR-1_v7.txt")
SS____ <- fread("single_tag_files/background_subtracted_single_tag_files/SS_minus_norm_miR-1_v7_HYBRID20190731.txt") #The new data.

# SS____[,253] <- SS____[,1]
# SS____[,1] <- NULL

#removes the 250 and the first 7 nt. 
...
write.table(m,"model_input_files/miR-1_minus_sample_mean_tails_50tags_with_expr_background_subtracted_v7_st_last20rm_HYBRID20190731.txt",row.names=FALSE,quote=FALSE,sep="\t")
