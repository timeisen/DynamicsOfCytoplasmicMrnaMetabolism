...
for(i in 1:10){
	...
	print("Writing files ...")
	write.table(tp40m_bs,file=paste0("single_tag_files/background_subtracted_single_tag_files/bootstrap/tp40m_bs_minus_miR-155_v6_BOOTSTRAP_",i,".txt"),quote=FALSE,row.names=FALSE,sep="\t",col.names=FALSE)
	write.table(tp1hr_bs,file=paste0("single_tag_files/background_subtracted_single_tag_files/bootstrap/tp1hr_bs_minus_miR-155_v6_BOOTSTRAP_",i,".txt"),quote=FALSE,row.names=FALSE,sep="\t",col.names=FALSE)
	write.table(tp2hr_bs,file=paste0("single_tag_files/background_subtracted_single_tag_files/bootstrap/tp2hr_bs_minus_miR-155_v6_BOOTSTRAP_",i,".txt"),quote=FALSE,row.names=FALSE,sep="\t",col.names=FALSE)
	write.table(tp4hr_bs,file=paste0("single_tag_files/background_subtracted_single_tag_files/bootstrap/tp4hr_bs_minus_miR-155_v6_BOOTSTRAP_",i,".txt"),quote=FALSE,row.names=FALSE,sep="\t",col.names=FALSE)
	write.table(tp8hr_bs,file=paste0("single_tag_files/background_subtracted_single_tag_files/bootstrap/tp8hr_bs_minus_miR-155_v6_BOOTSTRAP_",i,".txt"),quote=FALSE,row.names=FALSE,sep="\t",col.names=FALSE)
	write.table(tpSS__bs,file=paste0("single_tag_files/background_subtracted_single_tag_files/bootstrap/tpSS_minus_norm_miR-155_BOOTSTRAP_",i,".txt"),quote=FALSE,row.names=FALSE,sep="\t",col.names=FALSE)
