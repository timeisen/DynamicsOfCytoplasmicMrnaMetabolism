...
for(i in 1:10){
	...
	write.table(m,paste0("model_input_files/bootstrap/miR-155_minus_sample_mean_tails_50tags_with_expr_background_subtracted_v6_st_BOOTSTRAP_",i,".txt"),row.names=FALSE,quote=FALSE,sep="\t")
}